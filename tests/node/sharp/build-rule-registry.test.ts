...
import { buildRuleRegistry } from '../../../src/scripts/node/sharp/build-rule-registry';
...
describe('buildRuleRegistry', () => {
    ...
    test('rejects a module that exports no rule class', async () => {
        ...
        await expect(buildRuleRegistry(dir)).rejects.toThrow(/is expected to export a rule class, but it doesn't/);
    });
